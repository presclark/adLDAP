...
class adLDAP {
    ...
    */
    public function adldap_schema($attributes) {
		array_walk($attributes, array($this, 'encode8bit')); // Check every attribute to see if it contains 8bit characters and then UTF8 encode them
